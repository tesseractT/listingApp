...
class LocationController extends Controller
{
    ...
    public function store(LocationStoreRequest $request): RedirectResponse
    {
        ...
        return to_route('admin.location.index')->with('success', 'Location created successfully');
    }
    ...
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        return to_route('admin.location.index')->with('success', 'Location updated successfully');
    }
