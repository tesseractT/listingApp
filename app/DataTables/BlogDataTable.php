    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                $delete = '<a href ="' . route('admin.blog.destroy', $query->id) . '" class="delete-item btn btn-sm btn-danger ml-2"><i class="fas fa-trash"></a>';
                return $edit . $delete;
            })
            ...
            ->rawColumns(['action', 'image', 'category', 'status', 'is_popular'])
            ->setRowId('id');
    }
