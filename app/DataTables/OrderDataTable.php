    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $show = '<a href ="' . route('admin.orders.show', $query->id) . '" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>';
                $delete = '<a href ="' . route('admin.orders.destroy', $query->id) . '" class="delete-item btn btn-sm btn-danger ml-2"><i class="fas fa-trash"></a>';
