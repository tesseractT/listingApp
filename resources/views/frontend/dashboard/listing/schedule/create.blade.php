                ...
                <div class="col-lg-9">
                    <div class="dashboard_content">
                        <div class="my_listing">
                            <a href="{{ route('user.listing-schedule.index', $listing_id) }}" class="btn btn-primary"><i
                                    class="fas fa-chevron-left"></i></a>
                            <h4 style="justify-content: space-between">Create schedules
                            </h4>
                            <form action="{{ route('user.listing-schedule.store', $listing_id) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    <button type="submit" class="read_btn mt-4">Create Schedule</button>
                                </div>
                            </form>
