                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="main_blog">
                        ...
                        <ul class="main_blog_header">
                            ...
                            <li><a href="javascript:;"><i class="fal fa-comment-dots"></i> {{ count($blog->comments) }}
                                    Comments</a></li>
                            <li><a href="javascript:;"><i class="fal fa-eye"></i> {{ $blog->views }} Views</a></li>
                            <li><a href="javascript:;"><i class="fal fa-tags"></i> {{ $blog->category->name }} </a></li>
                        </ul>
                        <h4>{{ $blog->title }}</h4>
                        {!! $blog->content !!}
                        <div class="blog_comment_area">
                            <h5 class="wsus__single_comment_heading">Total Comment ({{ count($blog->comments) }})
                            </h5>
                            ...
                            @foreach ($popularBlogs as $popularBlog)
                                <a href="{{ route('blog.show', $popularBlog->slug) }}" class="sidebar_blog_single">
                                    ...
                                    <div class="sidebar_blog_text">
                                        <h5>{{ truncateText($popularBlog->title, 120) }}</h5>
                                        <p> <span>{{ date('d M Y', strtotime($popularBlog->created_at)) }} </span>
                                            {{ count($popularBlog->comments) }}
                                            Comments </p>
                                    </div>
                                </a>
                            @endforeach
