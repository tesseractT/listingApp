        ...
        <div class="row text-white">
                    ...
                    <ul class="footer_link">
                        @foreach (Menu::getByName('Footer Menu One') as $footerMenuOne)
                            <li><a href="{{ $footerMenuOne['link'] }}"><i
                                        class="far fa-chevron-double-right"></i>{{ $footerMenuOne['label'] }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="col-xl-2 col-sm-6 col-md-3 col-lg-3">
                <div class="footer_text">
                    <h3>Helpful Links</h3>
                    <ul class="footer_link">
                        @foreach (Menu::getByName('Footer Menu Two') as $footerMenuTwo)
                            <li><a href="{{ $footerMenuTwo['link'] }}"><i
                                        class="far fa-chevron-double-right"></i>{{ $footerMenuTwo['label'] }}</a>
                            </li>
                        @endforeach
            ...
            <div class="col-xl-2 col-sm-6 col-md-3 col-lg-3">
                <div class="footer_text">
                    <h3>Information</h3>
                    <ul class="footer_link">
                        @foreach (Menu::getByName('Footer Menu Three') as $footerMenuThree)
                            <li><a href="{{ $footerMenuThree['link'] }}"><i
                                        class="far fa-chevron-double-right"></i>{{ $footerMenuThree['label'] }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
