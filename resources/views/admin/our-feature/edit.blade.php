            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.our-features.update', $ourFeature->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div role="iconpicker" data-align="left" data-unselected-class=""
                                            data-selected-class="btn-primary" name="icon"
                                            data-icon="{{ $ourFeature->icon }}"></div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="">Title <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="title"
                                        value="{{ $ourFeature->title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Short Description <span class="text-danger">*</span></label>
                                    <textarea name="short_description" class="form-control" value="" cols="30" rows="10">{{ $ourFeature->short_description }}</textarea>
                                </div>
                                <div class="form-group">
