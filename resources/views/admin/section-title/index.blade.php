            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.section-title.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="our_categories_title"
                                        value="{{ $title?->our_categories_title }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="our_location_title"
                                        value="{{ $title?->our_location_title }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="">Our Featured Listing Title <span
                                ...
                                <div class="form-group">
                                    <label for="">Our Featured Listing Sub Title <span
                                            class="text-danger"></span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="our_our_pricing_title"
                                        value="{{ $title?->our_our_pricing_title }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="our_testimonial_title"
                                        value="{{ $title?->our_testimonial_title }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Our Testimonial Sub Title <span
                                            class="text-danger"></span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="our_blog_title"
                                        value="{{ $title?->our_blog_title }}">
                                </div>
