                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">Stripe Status <span class="text-danger">*</span></label>
                            <select name="stripe_status" class="form-control">
                                <option @selected(config('payment.stripe_status') === 'active') value="active">Active
                                </option>
                                <option @selected(config('payment.stripe_status') === 'inactive') value="inactive">Inactive
                                </option>
                            </select>
