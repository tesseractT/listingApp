                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">Paypal Status <span class="text-danger">*</span></label>
                            <select name="paypal_status" class="form-control">
                                <option @selected(config('payment.paypal_status') === 'active') value="active">Active
                                </option>
                                <option @selected(config('payment.paypal_status') === 'inactive') value="inactive">Inactive
                                </option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Paypal Mode <span class="text-danger">*</span></label>
                            <select name="paypal_mode" class="form-control">

                                <option @selected(config('payment.paypal_mode') === 'sandbox') value="sandbox">Sandbox
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="paypal_country" class="form-control select2">
                                ...
                                @foreach (config('countries') as $key => $country)
                                    <option @selected($key === config('payment.paypal_country')) value="{{ $key }}">
                                        {{ $country }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="paypal_app_key" class="form-control"
