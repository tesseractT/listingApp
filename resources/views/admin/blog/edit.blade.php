    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('admin.blog.index') }}">All Blog
                    </a></div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.blog.update', $blog->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control summernote" id="" cols="30" rows="10">{!! $blog->content !!}</textarea>
                                </div>
                                <div class="form-group">
