    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('admin.listing.index') }}">All Listings</a></div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.listing.update', $listing->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="">Google Map Embed Link <span class="text-danger">(Size: 1000 x
                                            400)</span></label>
