    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('admin.listing-schedule.index', $listing_id) }}" class="btn btn-icon"><i
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a
                        href="{{ route('admin.listing-schedule.index', $listing_id) }}">Listing Schedules
                    </a></div>
                <div class="breadcrumb-item active"><a href="{{ route('admin.listing.index') }}">Listings
                    </a></div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.listing-schedule.store', $listing_id) }}" method="POST">
                                @csrf
