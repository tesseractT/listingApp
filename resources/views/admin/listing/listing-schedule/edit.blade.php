    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('admin.listing-schedule.index', $schedule->listing_id) }}" class="btn btn-icon"><i
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a
                        href="{{ route('admin.listing-schedule.index', $schedule->listing_id) }}">Listing Schedules
                    </a></div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.listing-schedule.update', $schedule->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="start_time" class="form-control timepicker-1"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="end_time" class="form-control timepicker-2"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">Update Listing Schedule</button>
                                </div>
                            </form>
                        </div>
                    </div>
