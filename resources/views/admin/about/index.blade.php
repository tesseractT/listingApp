                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.about-us.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control summernote" id="" cols="30" rows="10">{!! $about?->description !!}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="">Learn More Link<span class="text-danger"></span></label>
